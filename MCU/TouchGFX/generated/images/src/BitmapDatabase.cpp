...
extern const unsigned char image_alternate_theme_images_dividers_vertical_medium_thin_dark[]; // BITMAP_ALTERNATE_THEME_IMAGES_DIVIDERS_VERTICAL_MEDIUM_THIN_DARK_ID = 3, Size: 2x320 pixels
